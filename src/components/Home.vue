...
<div>
	...
	<!--latest-post-->
    <div class="copyrights">Collect from <a href="http://www.htmlsucai.com" >免费网站模板</a></div>
		<!--top-games-section-->
		...
		<div class="latest-post">
			...
			<div class="grid">
				<figure class="effect-hera">
						<img src="../assets/images/l1.jpg" alt="img07"/>
						<figcaption>
					...
					<figure class="effect-hera">
						<img src="../assets/images/l2.jpg" alt="img07"/>
						<figcaption>
							<h2>Play <span>Games</span></h2>
							<p>
								<a href="#"><i class="download"></i></a>
					...
					<figure class="effect-hera">
						<img src="../assets/images/l3.jpg" alt="img07"/>
						<figcaption>
							<h2>Play <span>Games</span></h2>
							<p>
								<a href="#"><i class="download"></i></a>
					...
					<figure class="effect-hera">
						<img src="../assets/images/l4.jpeg" alt="img07"/>
						<figcaption>
							<h2>Play <span>Games</span></h2>
							<p>
								<a href="#"><i class="download"></i></a>
				 ...
				 <div class="blog">
				   <div class="col-md-4 blog-text">
					...
					<div class="col-md-8 welcome-img">
					 <a href="single.html" class="mask"><img src="../assets/images/b2.jpg" alt="image" class="img-responsive zoom-img"></a>
					</div>
				   <div class="clearfix"> </div>
			   </div>
			    <div class="blog">
				 <div class="col-md-4 blog-text two">
					...
					<div class="col-md-8 blog-img two">
					 <a href="single.html" class="mask"><img src="../assets/images/b3.jpg" alt="image" class="img-responsive zoom-img"></a>
					</div>
				   <div class="clearfix"> </div>
			   </div> 
			    <div class="blog">
				   <div class="col-md-4 blog-text">
					...
					<div class="col-md-8 welcome-img">
					 <a href="single.html" class="mask"><img src="../assets/images/b1.jpg" alt="image" class="img-responsive zoom-img"></a>
					</div>
				   <div class="clearfix"> </div>
			   </div>
		</div>
...
@media (max-width:768px){
	span.menu{
	  width: 35px;
	  height: 35px;
	  background: url(../assets/images/nav.png)no-repeat 0px 0px;
	  display: inline-block;
	  cursor: pointer;
	  position: absolute;
	  right: 3%;
...
.callbacks_nav {
  ...
  height: 70px;
  width: 40px;
  background: transparent url("../assets/images/arrows2.png") no-repeat left top;
  margin-top:1%;
}
...
i.s2{
  background: url(../assets/images/icons.png') no-repeat -60px 0px;
}
i.s3 {
  background: url(../assets/images/icons.png') no-repeat -120px 0px;
}
.latest-post {
...
.nbs-flexisel-nav-left {
   left: 0%;
  background: url(../assets/images/arrows.png) no-repeat -39px -0px;
}
.nbs-flexisel-nav-right {
  right: 0%;
  background: url(../assets/images/arrows.png) no-repeat 1px -0px;
}
...
a  i.download,a  i.heart,a i.service,a i.share{
 ...
 height:32px;
 display:inline-block;
 background:url(../assets/images/icons.png) no-repeat -6px -60px;
   margin-right: 0.6em;
}
a  i.download:hover{
 background:url(../assets/images/icons.png) no-repeat  -6px -92px;
}
a  i.heart{
  background:url(../assets/images/icons.png) no-repeat  -37px -60px;
}
a  i.heart:hover{
  background:url(../assets/images/icons.png) no-repeat  -37px -92px;
}
a  i.service{
  background:url(../assets/images/icons.png) no-repeat  -68px -60px;
}
a  i.service:hover{
  background:url(../assets/images/icons.png) no-repeat  -68px -92px;
}
a  i.share{
  background:url(../assets/images/icons.png) no-repeat  -98px -60px;
}
a  i.share:hover{
  background:url(../assets/images/icons.png) no-repeat  -98px -92px;
}
/*--blog--*/
.blog {
  background: #5bb2fc;
...
.single-one span i {
  background: url(../assets/images/icons.png)no-repeat -180px -2px;
  width: 25px;
  height: 25px;
  display: inline-block;
...
.single-one span i:hover {
  background: url(../assets/images/icons.png)no-repeat -180px -27px;
}
.single-one span i.com{
	background: url(../assets/images/icons.png)no-repeat -205px -2px;
}
.single-one span i.com:hover{
	background: url(../assets/images/icons.png)no-repeat -205px -27px;
}
.single-one span i.four{
	background: url(../assets/images/icons.png)no-repeat -230px -0px;
}
.single-one span i.four:hover{
	background: url(../assets/images/icons.png)no-repeat -230px -25px;
}
 p.eget {
  font-size: 0.9em;
  font-weight: 400;
...
ul.social-share li  i{
  background: url(../assets/images/icons.png)no-repeat -255px -2px;
  width:25px;
  height:25px;
  display: inline-block;
  margin: 0 12px;
...
ul.social-share li  i:hover{
	background: url(../assets/images/icons.png)no-repeat -255px -27px;
}
ul.social-share li  i.tin{
	background: url(../assets/images/icons.png)no-repeat -282px -2px;
}
ul.social-share li  i.tin:hover{
	background: url(../assets/images/icons.png)no-repeat -282px -27px;
}
ul.social-share li  i.message{
	background: url(../assets/images/icons.png)no-repeat -305px -2px;
}
ul.social-share li  i.message:hover{
	background: url(../assets/images/icons.png)no-repeat -305px -27px;
}
...
i.arrow{
  background: url(../assets/images/icons.png)no-repeat -335px -2px;
  width: 25px;
  height: 25px;
  display: inline-block;
  float: right;
...
i.arrow:hover{
 background: url(../assets/images/icons.png)no-repeat -335px -27px;
}
.comments-top-top{
	background:#F4F4F4;
}
...
p.reply i{
  background: url(../assets/images/icons.png)no-repeat -359px -4px;
  width: 25px;
  height: 25px;
  display: inline-block;
  vertical-align: middle;
...
p.reply i:hover{
     background: url(../assets/images/icons.png)no-repeat -359px -29px;
}
...
/*--about--*/
.banner.two {
  background: url(../assets/images/banner-two.jpg) no-repeat center top;
...
.test-text{
  background: url(../assets/images/4.jpg) no-repeat center top;
  background-size: cover;
  -webkit-background-size: cover;
  -moz-background-size: cover;
  -o-background-size: cover;
...
#toTop {
  ...
  border: none;
  text-indent: 100%;
  background: url(../assets/images/move-top.png) no-repeat 0px 0px;
}
/*--Responsive*--*/
...
@media (max-width:768px){
	...
	i.s1 {
	  background: url(../assets/images/icons.png') no-repeat 3px 0px;
	  background-size: 650%;
	}
	i.s2 {
	  background: url(../assets/images/icons.png') no-repeat -34px 0px;
	  background-size: 650%;
	}
	i.s3 {
	  background: url(../assets/images/icons.png') no-repeat -68px 0px;
	  background-size: 650%;
	}
	.icon {
	  float: left;
